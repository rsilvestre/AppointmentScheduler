          ...
          <v-flex xs10 offset-xs1>
            <v-card>
              <v-stepper v-model="e6" vertical>
                <v-stepper-step step="1" :complete="e6 > 1" editable>Choose a day for your appointment</v-stepper-step>
                ...
                <v-stepper-step step="2" editable :complete="e6 > 2">Choose an available time for your appointment</v-stepper-step>

                <v-stepper-content step="2">
                  <v-flex xs11 sm5>
                    <v-select v-bind:items="items" v-model="e1" label="Select" item-value="text" single-line bottom/>
                  </v-flex>
                ...
                <v-stepper-step step="3" editable :complete="e6 > 3">Give a description of the Event</v-stepper-step>

                <v-stepper-content step="3">
                  <v-text-field name="descriptor" v-model="description" label="Event Description" multi-line />
                  <v-btn flat color="primary"  @click.native="e6 = 4">OK</v-btn>
                </v-stepper-content>

                <v-stepper-step step="4" editable :complete="e6 > 4">Select the Location</v-stepper-step>

                <v-stepper-content step="4" >
                  <google-map @addLocation="addLocations"/>
                </v-stepper-content>

                <v-stepper-step step="5" editable :complete="e6 > 5">Share your contact information with us and we 'll send you a reminder</v-stepper-step>
                ...
                <v-stepper-content step="5">
                  ...
                  <v-dialog v-model = "dialog" persistent max-width ="750">
                    <v-card>
                      <div v-for="user in userArray" :key="user.email">
                        <v-spacer />
                        <v-flex xs12 sm6 md4>
                          <v-spacer />
